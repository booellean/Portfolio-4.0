...
export class DesignComponent implements OnInit {
  ...
  banners =[{
   ...
   description: `The Urban Indian Health Institute is a division of the Seattle Indian Health Board (SIHB), a nonprofit that provides free health care to Native American People. This banner is for the site's donation page. This donation banner encapsulates the services of SIHB, such as the synchronization of both western and traditional medicine to the Native community, youth services, and of course community. With the exception of the far left image, these images were taken during SIHB community activities.`,
   date: 1501200000,
   show: false
 },{
 ...
 logos =[{
   ...
   description: `Because this logo is relatively simple, let me explain the reasoning behind it. The butterfly is my favorite insect, and one of my favorite creatures in general. When I was a child, I use to collect caterpillars to observer their metamorphosis cycle, and as an adult I've come to appreciate its poetic history. Most of myself today is a change from who I was and who I wanted to be. I am happy for this change and where it has taken me. For this reason, I composed my first and last initials E and P into the shape of the butterfly.`,
   date: 1508457600,
   show: false
 },{
   ...
   description: `The Urban Indian Health Institute commissioned a general purpose logo for all forms of Pride. However, prior to that commission, this logo was created for Trans-Pride, and in particular Two-Spirit awareness. Similar to Trans, Two-Spirit is a non-binary identity of the American Indian and Alaska Native people that was written out of history during western colonization. The two feathers joining to form a double helix is representative of the multiple identities that encompass a single person, and how these identities are ingrained in us and our being.`,
   date: 1497916800,
   show: false
 }];
 ...
 icons =[{
   ...
   title: 'Diabetes Report Iconography - Physical Education',
   ...
   fileType: '.png',
   link: 'http://www.uihi.org/wp-content/uploads/2017/11/2016_Diabetes_Update_Electronic.pdf',
   title: 'Diabetes Report Iconography - Oral Care',
   ...
   fileType: '.png',
   link: 'http://www.uihi.org/wp-content/uploads/2017/11/2016_Diabetes_Update_Electronic.pdf',
   title: 'Diabetes Report Iconography - Tobacco Screening',
   ...
   fileType: '.png',
   link: 'http://www.uihi.org/wp-content/uploads/2017/11/2016_Diabetes_Update_Electronic.pdf',
   title: 'Diabetes Report Iconography - Kidneys',
   ...
   fileType: '.png',
   link: 'http://www.uihi.org/wp-content/uploads/2017/11/2016_Diabetes_Update_Electronic.pdf',
   title: 'Diabetes Report Iconography - Heart Health',
   ...
   fileType: '.png',
   link: 'http://www.uihi.org/wp-content/uploads/2017/11/2016_Diabetes_Update_Electronic.pdf',
   title: 'Diabetes Report Iconography - Foot Exam',
   ...
   fileType: '.png',
   link: 'http://www.uihi.org/wp-content/uploads/2017/11/2016_Diabetes_Update_Electronic.pdf',
   title: 'Diabetes Report Iconography - Depression Screening',
   ...
   fileType: '.png',
   link: 'http://www.uihi.org/wp-content/uploads/2017/11/2016_Diabetes_Update_Electronic.pdf',
   title: 'Diabetes Report Iconography - Education',
